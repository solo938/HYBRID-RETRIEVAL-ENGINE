# Local Quickstart# How to Get Started with Qdrant Locally
...
See [payload and vector in the result](/documentation/search/search/index.md#payload-and-vector-in-the-result) on how to enable it.
...
Now you know how Qdrant works. Getting started with [Qdrant Cloud](/documentation/cloud-quickstart/index.md) is just as easy. [Create an account](https://qdrant.to/cloud) and use our SaaS completely free. We will take care of infrastructure maintenance and software updates.

To move onto some more complex examples of vector search, read our [Tutorials](/documentation/tutorials-lp-overview/index.md) and create your own app with the help of our [Examples](/documentation/examples/index.md).

When you're ready to deploy, run through the [Production Checklist](/documentation/production-checklist/index.md) to make sure your instance is secure and optimized.
