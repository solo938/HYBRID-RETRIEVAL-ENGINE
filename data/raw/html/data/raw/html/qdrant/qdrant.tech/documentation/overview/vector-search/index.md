...
For those who want to start writing code right away, visit our [Complete Beginners tutorial](/documentation/tutorials-basics/search-beginners/index.md) to build a search engine in 5-15 minutes.
...
<figure><img src="/docs/gettingstarted/inverted-index.png"
    alt="A simplified version of the inverted index."><figcaption>
      <p>A simplified version of the inverted index.</p>
    </figcaption>
</figure>
...
<figure><img src="/docs/gettingstarted/tokenization.png"
    alt="The process of tokenization with an additional stopwords removal and conversion to root form of a word."><figcaption>
      <p>The process of tokenization with an additional stopwords removal and conversion to root form of a word.</p>
    </figcaption>
</figure>
...
<figure><img src="/docs/gettingstarted/query.png"
    alt="An example of a query vectorized to sparse format."><figcaption>
      <p>An example of a query vectorized to sparse format.</p>
    </figcaption>
</figure>
...
<figure><img src="/docs/gettingstarted/babel.jpg"
    alt="The Tower of Babel, Pieter Bruegel."><figcaption>
      <p>The Tower of Babel, Pieter Bruegel.</p>
    </figcaption>
</figure>
...
<figure><img src="/docs/gettingstarted/input.png"
    alt="Input queries contain different words, but they are still converted into similar vector representations, because the neural encoder can capture the meaning of the sentences. That feature can capture synonyms but also different languages.."><figcaption>
      <p>Input queries contain different words, but they are still converted into similar vector representations, because the neural encoder can capture the meaning of the sentences. That feature can capture synonyms but also different languages..</p>
    </figcaption>
</figure>
...
<figure><img src="/docs/gettingstarted/vector-search.png"
    alt="Vector search with Qdrant. Thanks to HNSW graph we are able to compare the distance to some of the objects from the database, not to all of them."><figcaption>
      <p>Vector search with Qdrant. Thanks to HNSW graph we are able to compare the distance to some of the objects from the database, not to all of them.</p>
    </figcaption>
</figure>
...
[**Tutorial 1 - Qdrant for Complete Beginners**](/documentation/tutorials-basics/search-beginners/index.md)
Despite its complicated background, vectors search is extraordinarily simple to set up. With Qdrant, you can have a search engine up-and-running in five minutes. Our [Complete Beginners tutorial](/documentation/tutorials-basics/search-beginners/index.md) will show you how.

[**Tutorial 2 - Question and Answer System**](/articles/qa-with-cohere-and-qdrant/index.md)
However, you can also choose SaaS tools to generate them and avoid building your model. Setting up a vector search project with Qdrant Cloud and Cohere co.embed API is fairly easy if you follow the [Question and Answer System tutorial](/articles/qa-with-cohere-and-qdrant/index.md).
