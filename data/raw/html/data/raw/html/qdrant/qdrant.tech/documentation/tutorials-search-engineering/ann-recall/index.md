...
- **Retrieval relevance** ([Measuring Retrieval Relevance](/documentation/improve-search/retrieval-relevance/index.md)). Do the top-k results match query intent?
- **Pipeline output quality** ([Evaluating Pipeline Output Quality](/documentation/improve-search/pipeline-output-quality/index.md)). Does the end-to-end pipeline (retrieval + generator, ranker, or UI) produce the right output?
...
Once ANN recall is on target, continue with [Measuring Retrieval Relevance](/documentation/improve-search/retrieval-relevance/index.md) to check how well those results match user intent.