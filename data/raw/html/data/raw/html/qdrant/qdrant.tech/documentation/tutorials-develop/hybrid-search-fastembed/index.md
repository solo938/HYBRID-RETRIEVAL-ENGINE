...
As we have already written on our [blog](/articles/hybrid-search/index.md), there is no single definition of hybrid search. 
In this tutorial we are covering the case with a combination of dense and [sparse embeddings](/articles/sparse-vectors/index.md). 
...
Qdrant supports 2 fusion functions for combining the results: [reciprocal rank fusion](https://plg.uwaterloo.ca/~gvcormac/cormacksigir09-rrf.pdf) and [distribution based score fusion](/documentation/search/hybrid-queries/index.md?q=distribution+based+sc#:~:text=Distribution%2DBased%20Score%20Fusion)
