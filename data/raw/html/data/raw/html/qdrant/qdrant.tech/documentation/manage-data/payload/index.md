...
For example, you will get an empty output if you apply the [range condition](/documentation/search/filtering/index.md#range) on the string data.
...
The filtering process is discussed in detail in the section [Filtering](/documentation/search/filtering/index.md).
...
The indexed fields also affect the vector index. See [Indexing](/documentation/manage-data/indexing/index.md) for details.
