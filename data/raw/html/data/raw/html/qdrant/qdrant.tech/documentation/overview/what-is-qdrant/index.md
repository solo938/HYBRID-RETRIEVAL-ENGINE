...
- [Collections](/documentation/manage-data/collections/index.md): A collection is a named set of points (vectors with a payload) among which you can search. The vector of each point within the same collection must have the same dimensionality and be compared by a single metric. [Named vectors](/documentation/manage-data/collections/index.md#collection-with-multiple-vectors) can be used to have multiple vectors in a single point, each of which can have their own dimensionality and metric requirements.
...
- [Points](/documentation/manage-data/points/index.md): The points are the central entity that 
Qdrant operates with and they consist of a vector and an optional id and payload.
    - id: a unique identifier for your vectors.
    - Vector: a high-dimensional representation of data, for example, an image, a sound, a document, a video, etc.
    - [Payload](/documentation/manage-data/payload/index.md): A payload is a JSON object with additional data you can add to a vector.
- [Storage](/documentation/manage-data/storage/index.md): Qdrant can use one of two options for 
