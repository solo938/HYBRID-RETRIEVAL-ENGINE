...
|--------------|----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| **Beginner** | [Qdrant Edge Quickstart](/documentation/edge/edge-quickstart/index.md)             | Get started with Qdrant Edge and learn the basics of managing and querying data |
| **Beginner** | [On-Device Embeddings](/documentation/edge/edge-fastembed-embeddings/index.md)     | Generate vector embeddings directly on edge devices using FastEmbed |
| **Beginner** | [On-Device BM25](/documentation/edge/edge-bm25/index.md)                          | Generate BM25 sparse embeddings on-device for keyword search |
| **Reference** | [Data Synchronization Patterns](/documentation/edge/edge-data-synchronization-patterns/index.md) | Overview of patterns for synchronizing data between Edge Shards and Qdrant server collections |
| **Advanced** | [Synchronize with a Server](/documentation/edge/edge-synchronization-guide/index.md) | Synchronize an Edge Shard with a Qdrant server collection to offload indexing and synchronize data between devices |
